...
from cyptography.exceptions import InvalidSignature
...
def should_verify(backend, wycheproof):
  ...
  if wycheproof.acceptable:
    if (
      (
        backend._lib.CRYPTOGRAPHY_OPENSSL_110_GREATER or
...
@pytest.mark.wycheproof_tests(
  ...
  "rsa_signature_3073_sha256_test.json",
...
@pytest.mark.wycheproof_tests(
  ...
  "rsa_pss_2048_sha256_msf1_32_test.json",
  "rsa_pss_3072_sha256_msf1_32_test.json",
...
def test_rsa_pss_signature(backend, wycheproof):
  ...
  msf_digest = _DIGESTS[wycheproof.testgroup["msfSha"]]
